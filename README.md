·Developed a Java Spring MVC application that communicates with a MySQL database to allow the user to create, read, update and delete employee information.
